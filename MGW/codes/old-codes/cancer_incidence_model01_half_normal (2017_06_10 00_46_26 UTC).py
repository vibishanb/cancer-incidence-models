""" This code is a stand-alone simulation with all parameters initialized and contained within.
This could be improved by making it a function to which simulation parameters can be passed, in order to
accelerate testing of parameters. The formatting and writing of new Excel sheets, however, could be tricky. """
...
growth_adv_dist = np.normal (0, 0.5, N_pop) #Half-normal distribution of potential mutation advantage in the population

""" log_count = [0.0] * 81 #Array for log values of cancer_count
log_age = [0.0] * 81 #Array for log values of age """

""" Main simulation of cancer in the population """
for i in pop_size:
    age = 20 #Starting age of the individual
    n = 10 ** 9 #Number of stem cells in a saturated tissue
    ...
    while age <= 100:
        ...
        if p_mut > a: #Simulation of stochastic mutation acquisition
            ...
            if n_mut < 5:
                ...
                #n = n - mut_pop #Replacement of normal cells by mutants
...
""" # Log values of age for logarithmic scale
i = 0
