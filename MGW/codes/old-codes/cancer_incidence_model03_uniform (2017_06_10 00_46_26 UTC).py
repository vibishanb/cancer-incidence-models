...
N_pop = 50000 #Size of the whole population of individuals
p = 4 * 10 ** -8 #Probability of mutation in a given locus per cell per generation
...
growth_adv_dist = np.uniform (-1.5, 1.5, N_pop) #Uniform distribution of potential mutation advantage in the population
