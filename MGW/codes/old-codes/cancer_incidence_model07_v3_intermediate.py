...
p=1.25*10**-8 #Mutation probability
growth_rate=np.normal(-0.1, 1.35, N_pop) #Growth rate distribution
##g_initial=[]
...
crude_rate=[0]*age #Calculated age-wise incidence per 100000
