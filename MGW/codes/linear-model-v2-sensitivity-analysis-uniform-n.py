...
k = 5
for j, n in zip(tqdm(range(Npop), desc='Npop', ascii=True, leave=False), ndist):
...
plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/sensitivity-figures/gdist-16Nov/23Dec/linear-v2-gdist-uniform-nrand-cumul-count-23Dec.svg')
...
df_incidence.to_csv('/home/iiser/PhD/github-cancer-incidence-models/all-data/sensitivity-data/gdist-16Nov/23Dec/linear-v2-gdist-uniform-nrand-incidence-data-23Dec.csv')


# In[7]:


gdist_sens = pd.DataFrame(numpy.array([numpy.log10(ndist[cancer_time!=0]), gdist[cancer_time!=0], cancer_time[cancer_time!=0]/ndiv]).T, columns=['log(n)', 'g(k-1)', 'Time to cancer'])
...
gdist_sens.to_csv('/home/iiser/PhD/github-cancer-incidence-models/all-data/sensitivity-data/gdist-16Nov/23Dec/linear-v2-cancer-time-gdist-uniform-nrand-23Dec.xls')
...
plt.tight_layout()
plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/sensitivity-figures/gdist-16Nov/23Dec/linear-v2-g-vs-cancer-time-uniform-nrand-23Dec.svg')
...
plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/sensitivity-figures/gdist-16Nov/23Dec/linear-v2-p-vs-g-uniform-nrand-23Dec.svg')
...
plt.tight_layout()
plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/sensitivity-figures/gdist-16Nov/23Dec/linear-v2-n-vs-cancer-time-uniform-nrand-23Dec.svg')