"""
V1 [up to 29 December]: testing the context-dependent case over the range of p, for a single value of n.
...
plt.xlabel('log(p)')
plt.ylabel(r'$Age atfrac{I_{max}}{2}$')
...
# plt.savefig('/home/iiser/PhD/Research/cancer_project/cancer_incidence_model/linear_model/V1/figures/22Aug2018/linear_v1_mnratio_g.svg')
"""