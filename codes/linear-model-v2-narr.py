...
#df_crc.to_excel('/home/iiser/PhD/github-cancer-incidence-models/all-data/v2-data/22Oct2018/linear-v2-multipop-cancer-count-n.xlsx')

df_cc = pd.DataFrame(cmc, index = narr)
df_cc.index.names = ['Cell number']
df_cc.columns.names = ['Age']
#df_cc.to_excel('/home/iiser/PhD/github-cancer-incidence-models/all-data/v2-data/22Oct2018/linear-v2-multipop-cumulative-count-n.xlsx')

df_crr = pd.DataFrame(cmc, index = narr)
df_crr.index.names = ['Cell number']
df_crr.columns.names = ['Age']
#df_crr.to_excel('/home/iiser/PhD/github-cancer-incidence-models/all-data/v2-data/22Oct2018/linear-v2-multipop-crude-rate-n.xlsx')
...
plt.legend(loc='best')
#plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/v2-figures/22Oct2018/linear-v2-multipop-waiting-time-n.svg')
...
#plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/v2-figures/22Oct2018/linear-v2-multipop-age-halfmax-n.svg')
...
plt.xlabel('log(n)')
plt.ylabel(r'$I_{max}$')
#plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/v2-figures/22Oct2018/linear-v2-multipop-imax-n.svg')
...
# plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/v2-figures/22Oct2018/linear-v2-multipop-age-crude-incidence-n.svg')
...
# plt.savefig('/home/iiser/PhD/github-cancer-incidence-models/all-figures/v2-figures/22Oct2018/linear-v2-multipop-age-cumulative-incidence-n.svg')
